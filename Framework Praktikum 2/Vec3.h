...
#define M_DegToRad 0.0174532925f
...
public:
  ...
  {
    float y_new = cos(angle*M_DegToRad)*y - sin(angle*M_DegToRad)*z;
    float z_new = sin(angle*M_DegToRad)*y + cos(angle*M_DegToRad)*z;
    y = y_new;
    z = z_new;
  }
  ...
  {
    float x_new = cos(angle*M_DegToRad)*x + sin(angle*M_DegToRad)*z;
    float z_new = -sin(angle*M_DegToRad)*x + cos(angle*M_DegToRad)*z;
    x = x_new;
    z = z_new;
  }
  ...
  {
    float x_new = cos(angle*M_DegToRad)*x - sin(angle*M_DegToRad)*y;
    float y_new = sin(angle*M_DegToRad)*x + cos(angle*M_DegToRad)*y;
    x = x_new;
    y = y_new;
  }
